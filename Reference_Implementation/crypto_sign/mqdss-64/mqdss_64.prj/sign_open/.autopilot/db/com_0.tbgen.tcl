...
set C_modelArgList {
	...
	{ rho int 8 regular {array 43728 { 1 3 } 1 1 }  }
	{ rho_offset int 16 regular  }
	{ inn_offset int 16 regular  }
	{ inn2 int 8 regular {array 40 { 1 3 } 1 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "c", "interface" : "memory", "bitwidth" : 8, "direction" : "WRITEONLY"} , 
 	...
 	{ "Name" : "rho_offset", "interface" : "wire", "bitwidth" : 16, "direction" : "READONLY"} , 
 	{ "Name" : "inn_offset", "interface" : "wire", "bitwidth" : 16, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ rho_address0 sc_out sc_lv 16 signal 2 } 
	{ rho_ce0 sc_out sc_logic 1 signal 2 } 
	{ rho_q0 sc_in sc_lv 8 signal 2 } 
	{ rho_offset sc_in sc_lv 16 signal 3 } 
	{ inn_offset sc_in sc_lv 16 signal 4 } 
	{ inn2_address0 sc_out sc_lv 6 signal 5 } 
	{ inn2_ce0 sc_out sc_logic 1 signal 5 } 
	{ inn2_q0 sc_in sc_lv 8 signal 5 } 
	{ inm_address0 sc_out sc_lv 6 signal 6 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "rho_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "rho", "role": "address0" }} , 
 	...
 	{ "name": "rho_offset", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "rho_offset", "role": "default" }} , 
 	{ "name": "inn_offset", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "inn_offset", "role": "default" }} , 
 	{ "name": "inn2_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "inn2", "role": "address0" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "8"],
		...
		"Port" : [
			...
			{"Name" : "KeccakF_RoundConstan", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "4", "SubInstance" : "grp_keccak_absorb_2_fu_278", "Port" : "KeccakF_RoundConstan"},
					{"ID" : "8", "SubInstance" : "grp_keccak_squeezeblocks_fu_286", "Port" : "KeccakF_RoundConstan"}]}]},
	...
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_keccak_absorb_2_fu_278", "Parent" : "0", "Child" : ["5", "6"],
		...
		"Port" : [
			{"Name" : "s", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "6", "SubInstance" : "grp_KeccakF1600_StatePer_fu_275", "Port" : "state"}]},
			{"Name" : "m", "Type" : "Memory", "Direction" : "I"},
			{"Name" : "KeccakF_RoundConstan", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "6", "SubInstance" : "grp_KeccakF1600_StatePer_fu_275", "Port" : "KeccakF_RoundConstan"}]}]},
	{"ID" : "5", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_keccak_absorb_2_fu_278.t_U", "Parent" : "4"},
	{"ID" : "6", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_keccak_absorb_2_fu_278.grp_KeccakF1600_StatePer_fu_275", "Parent" : "4", "Child" : ["7"],
		...
		"Port" : [
			...
			{"Name" : "KeccakF_RoundConstan", "Type" : "Memory", "Direction" : "I"}]},
	{"ID" : "7", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.grp_keccak_absorb_2_fu_278.grp_KeccakF1600_StatePer_fu_275.KeccakF_RoundConstan_U", "Parent" : "6"},
	{"ID" : "8", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_keccak_squeezeblocks_fu_286", "Parent" : "0", "Child" : ["9"],
	...
	{"ID" : "9", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_keccak_squeezeblocks_fu_286.grp_KeccakF1600_StatePer_fu_131", "Parent" : "8", "Child" : ["10"],
		"CDFG" : "KeccakF1600_StatePer",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		...
		"Port" : [
			{"Name" : "state", "Type" : "Memory", "Direction" : "IO"},
			{"Name" : "KeccakF_RoundConstan", "Type" : "Memory", "Direction" : "I"}]},
	{"ID" : "10", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.grp_keccak_squeezeblocks_fu_286.grp_KeccakF1600_StatePer_fu_131.KeccakF_RoundConstan_U", "Parent" : "9"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "1579", "Max" : "1579"}
	, {"Name" : "Interval", "Min" : "1579", "Max" : "1579"}
]}
...
set Spec2ImplPortList { 
	...
	rho { ap_memory {  { rho_address0 mem_address 1 16 }  { rho_ce0 mem_ce 1 1 }  { rho_q0 mem_dout 0 8 } } }
	rho_offset { ap_none {  { rho_offset in_data 0 16 } } }
	inn_offset { ap_none {  { inn_offset in_data 0 16 } } }
	inn2 { ap_memory {  { inn2_address0 mem_address 1 6 }  { inn2_ce0 mem_ce 1 1 }  { inn2_q0 mem_dout 0 8 } } }
...
set RtlHierarchyInfo {[
	...
	{"ID" : "8", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_keccak_squeezeblocks_fu_286", "Parent" : "0", "Child" : ["9"],
		...
		"Port" : [
			...
			{"Name" : "s", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "9", "SubInstance" : "grp_KeccakF1600_StatePer_fu_135", "Port" : "state"}]},
			{"Name" : "KeccakF_RoundConstan", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "9", "SubInstance" : "grp_KeccakF1600_StatePer_fu_135", "Port" : "KeccakF_RoundConstan"}]}]},
	{"ID" : "9", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_keccak_squeezeblocks_fu_286.grp_KeccakF1600_StatePer_fu_135", "Parent" : "8", "Child" : ["10"],
		"CDFG" : "KeccakF1600_StatePer",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		...
		"Port" : [
			{"Name" : "state", "Type" : "Memory", "Direction" : "IO"},
			{"Name" : "KeccakF_RoundConstan", "Type" : "Memory", "Direction" : "I"}]},
	{"ID" : "10", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.grp_keccak_squeezeblocks_fu_286.grp_KeccakF1600_StatePer_fu_135.KeccakF_RoundConstan_U", "Parent" : "9"}]}
