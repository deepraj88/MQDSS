...
set C_modelArgList {
	{ out_r int 16 regular {array 64 { 2 3 } 1 1 }  }
}
...
set Spec2ImplPortList { 
	out_r { ap_memory {  { out_r_address0 mem_address 1 6 }  { out_r_ce0 mem_ce 1 1 }  { out_r_we0 mem_we 1 1 }  { out_r_d0 mem_din 1 16 }  { out_r_q0 mem_dout 0 16 } } }
}
set moduleName vgf31_shorten_unique
set isTaskLevelControl 1
set isCombinational 0
