...
set ID 148
set hasByteEnable 0
set MemName crypto_sign_keypair_F
...
set ID 149
set hasByteEnable 0
set MemName crypto_sign_keypair_skbuf
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 8
set AddrRange 32
...
set ID 150
set hasByteEnable 0
set MemName crypto_sign_keypair_sk_gf31
set CoreName ap_simcore_mem
set PortList { 2 1 }
set DataWd 5
set AddrRange 48
...
set ID 151
set hasByteEnable 0
set MemName crypto_sign_keypair_pk_gf31
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 16
set AddrRange 48
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename sk \
    op interface \
    ports { sk_address0 { O 4 vector } sk_ce0 { O 1 bit } sk_we0 { O 1 bit } sk_d0 { O 8 vector } sk_q0 { I 8 vector } } \
} "
} else {
