...
set C_modelArgList {
	...
	{ rho int 8 regular {array 8640 { 1 3 } 1 1 }  }
	{ rho_offset int 14 regular  }
	{ inn int 8 regular {array 30 { 1 3 } 1 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "c", "interface" : "memory", "bitwidth" : 8, "direction" : "WRITEONLY"} , 
 	...
 	{ "Name" : "rho_offset", "interface" : "wire", "bitwidth" : 14, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ rho_address0 sc_out sc_lv 14 signal 2 } 
	{ rho_ce0 sc_out sc_logic 1 signal 2 } 
	{ rho_q0 sc_in sc_lv 8 signal 2 } 
	{ rho_offset sc_in sc_lv 14 signal 3 } 
	{ inn_address0 sc_out sc_lv 5 signal 4 } 
	{ inn_ce0 sc_out sc_logic 1 signal 4 } 
	{ inn_q0 sc_in sc_lv 8 signal 4 } 
	{ inm_address0 sc_out sc_lv 5 signal 5 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "rho_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":14, "type": "signal", "bundle":{"name": "rho", "role": "address0" }} , 
 	...
 	{ "name": "rho_offset", "direction": "in", "datatype": "sc_lv", "bitwidth":14, "type": "signal", "bundle":{"name": "rho_offset", "role": "default" }} , 
 	{ "name": "inn_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "inn", "role": "address0" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "7"],
		...
		"Port" : [
			...
			{"Name" : "KeccakF_RoundConstan", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "4", "SubInstance" : "grp_keccak_squeezeblocks_fu_240", "Port" : "KeccakF_RoundConstan"}]}]},
	...
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_keccak_squeezeblocks_fu_240", "Parent" : "0", "Child" : ["5"],
	...
	{"ID" : "5", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_keccak_squeezeblocks_fu_240.grp_KeccakF1600_StatePer_fu_131", "Parent" : "4", "Child" : ["6"],
		...
		"Port" : [
			...
			{"Name" : "KeccakF_RoundConstan", "Type" : "Memory", "Direction" : "I"}]},
	{"ID" : "6", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.grp_keccak_squeezeblocks_fu_240.grp_KeccakF1600_StatePer_fu_131.KeccakF_RoundConstan_U", "Parent" : "5"},
	{"ID" : "7", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_keccak_absorb_3_fu_248", "Parent" : "0", "Child" : ["8"],
	...
	{"ID" : "8", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_keccak_absorb_3_fu_248.t_U", "Parent" : "7"}]}
...
set Spec2ImplPortList { 
	...
	rho { ap_memory {  { rho_address0 mem_address 1 14 }  { rho_ce0 mem_ce 1 1 }  { rho_q0 mem_dout 0 8 } } }
	rho_offset { ap_none {  { rho_offset in_data 0 14 } } }
	inn { ap_memory {  { inn_address0 mem_address 1 5 }  { inn_ce0 mem_ce 1 1 }  { inn_q0 mem_dout 0 8 } } }
