...
set portList { 
	...
	{ x_address1 sc_out sc_lv 15 signal 1 } 
	{ x_ce1 sc_out sc_logic 1 signal 1 } 
	{ x_q1 sc_in sc_lv 5 signal 1 } 
	{ x_offset sc_in sc_lv 33 signal 2 } 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "385", "Max" : "13921"}
	, {"Name" : "Interval", "Min" : "385", "Max" : "13921"}
]}
...
set C_modelArgMapList {[ 
	{ "Name" : "xij", "interface" : "memory", "bitwidth" : 6, "direction" : "WRITEONLY"} , 
 	...
 	{ "Name" : "x_offset", "interface" : "wire", "bitwidth" : 33, "direction" : "READONLY"} , 
 	{ "Name" : "y", "interface" : "memory", "bitwidth" : 16, "direction" : "READONLY"} , 
 	{ "Name" : "y_offset", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} ]}
# RTL Port declarations: 
set portNum 21
set portList { 
	{ ap_clk sc_in sc_logic 1 clock -1 } 
	...
	{ y_ce0 sc_out sc_logic 1 signal 3 } 
	{ y_q0 sc_in sc_lv 16 signal 3 } 
	{ y_offset sc_in sc_lv 64 signal 4 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	{ "name": "ap_rst", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "reset", "bundle":{"name": "ap_rst", "role": "default" }} , 
 	...
 	{ "name": "y_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "y", "role": "ce0" }} , 
 	{ "name": "y_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "y", "role": "q0" }} , 
 	{ "name": "y_offset", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "y_offset", "role": "default" }}  ]}
...
set Spec2ImplPortList { 
	...
	x_offset { ap_none {  { x_offset in_data 0 33 } } }
	y { ap_memory {  { y_address0 mem_address 1 13 }  { y_ce0 mem_ce 1 1 }  { y_q0 mem_dout 0 16 } } }
	y_offset { ap_none {  { y_offset in_data 0 64 } } }
}
set moduleName generate_xiyj_p_xjyi
set isTaskLevelControl 1
set isCombinational 0
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		...
		"Port" : [
			...
			{"Name" : "y", "Type" : "Memory", "Direction" : "I"},
			{"Name" : "y_offset", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.crypto_sign_mul_mul_16s_5ns_16_1_1_U127", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.crypto_sign_mac_muladd_16s_5ns_16s_16_1_1_U128", "Parent" : "0"}]}
