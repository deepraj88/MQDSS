...
set C_modelArgMapList {[ 
	{ "Name" : "c", "interface" : "memory", "bitwidth" : 8, "direction" : "WRITEONLY"} , 
 	...
 	{ "Name" : "rho_offset", "interface" : "wire", "bitwidth" : 13, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ rho_offset sc_in sc_lv 13 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "rho_offset", "direction": "in", "datatype": "sc_lv", "bitwidth":13, "type": "signal", "bundle":{"name": "rho_offset", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "7", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_keccak_absorb_4_fu_286", "Parent" : "0", "Child" : ["8"],
	...
	{"ID" : "8", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_keccak_absorb_4_fu_286.t_U", "Parent" : "7"}]}
...
set Spec2ImplPortList { 
	...
	rho_offset { ap_none {  { rho_offset in_data 0 13 } } }
