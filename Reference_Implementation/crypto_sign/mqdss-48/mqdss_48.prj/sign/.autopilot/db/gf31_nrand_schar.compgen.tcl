...
set ID 10
set hasByteEnable 0
set MemName gf31_nrand_schar_shakestate
...
set ID 11
set hasByteEnable 0
set MemName gf31_nrand_schar_output_assign
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 8
set AddrRange 136
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename out_r \
    op interface \
    ports { out_r_address0 { O 16 vector } out_r_ce0 { O 1 bit } out_r_we0 { O 1 bit } out_r_d0 { O 5 vector } } \
} "
} else {
