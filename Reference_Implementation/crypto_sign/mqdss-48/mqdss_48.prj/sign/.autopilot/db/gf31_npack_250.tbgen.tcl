...
set C_modelName {gf31_npack.250}
set C_modelType { void 0 }
set C_modelArgList {
	{ out_r int 8 regular {array 30 { 2 3 } 1 1 }  }
...
set portList { 
	...
	{ in_r_address0 sc_out sc_lv 13 signal 1 } 
	{ in_r_ce0 sc_out sc_logic 1 signal 1 } 
	{ in_r_q0 sc_in sc_lv 16 signal 1 } 
	{ in_offset sc_in sc_lv 64 signal 2 } 
}
set NewPortList {[ 
...
set Spec2ImplPortList { 
	out_r { ap_memory {  { out_r_address0 mem_address 1 5 }  { out_r_ce0 mem_ce 1 1 }  { out_r_we0 mem_we 1 1 }  { out_r_d0 mem_din 1 8 }  { out_r_q0 mem_dout 0 8 } } }
